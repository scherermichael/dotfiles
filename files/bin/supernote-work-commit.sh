...
rsync -a "${HOME}/Library/Containers/com.ratta.supernote/Data/Library/Application Support/com.ratta.supernote/1190396299514482688/Supernote/Note/work/"* "${HOME}/projects/obsidian-seal/Supernote"
git add -f . || exit 204
